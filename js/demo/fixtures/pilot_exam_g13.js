...
const PILOT_EXAM_G13 = [
  ...
  },
  {
    ...
    reviewStatus: 'PENDING_ACADEMIC_REVIEW',
    reviewer: null,
    stem: 'Khi thấy bạn ngồi bên cạnh đang buồn và lo lắng vì làm mất bút vẽ trước giờ tô màu, em nên chọn cách ứng xử nào?',
    options: [
  ...
  },
  {
    ...
    reviewStatus: 'PENDING_ACADEMIC_REVIEW',
    reviewer: null,
    stem: 'Sau giờ ra chơi, em thấy một vỏ gói bánh rơi trên lối đi chung ngoài hành lang. Hành động nào là phù hợp nhất?',
    options: [
      { id: 'opt_a', text: 'Nhặt vỏ gói bánh bỏ vào thùng rác gần nhất để giữ hành lang luôn sạch đẹp' },
      { id: 'opt_b', text: 'Bước qua rác và nghĩ rằng chút nữa bác bảo vệ sẽ dọn dẹp' },
      { id: 'opt_c', text: 'Gạt vỏ gói bánh sang sát góc tường để mọi người không dẫm vào' },
