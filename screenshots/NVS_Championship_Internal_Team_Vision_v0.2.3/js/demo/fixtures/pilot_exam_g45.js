...
const PILOT_EXAM_G45 = [
  ...
  },
  {
    ...
    options: [
      { id: 'opt_a', text: '"Có 85/100 học sinh tham khảo sát cho biết các bạn đọc sách ít nhất 20 phút mỗi ngày."' },
  ...
  },
  {
    ...
    options: [
      { id: 'opt_a', text: 'Giữ bình tĩnh, rà soát lại đề và ưu tiên làm câu em cảm thấy có căn cứ giải quyết cao nhất' },
