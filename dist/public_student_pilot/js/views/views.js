...
const Views = {
  ...
  renderHome() {
    ...
    return `
      <div class="ns-view" data-view="home" style="flex: 1; display: flex; flex-direction: column; width: 100%; box-sizing: border-box;">
        ...
        <!-- Championship Training Hub Feature Card -->
        <div class="ns-card" style="background: linear-gradient(135deg, #1E1B4B, #312E81); color: #FFF; border-color: #FDE047; border-width: 3.5px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
            <h3 style="font-family: var(--font-display); font-weight: 700; font-size: 1.3rem; color: #FDE047; margin: 0;">🏆 Đấu trường NVS</h3>
            <span class="ns-hud-badge" style="background: #F59E0B; color: #FFF; font-size: 0.75rem; font-weight: 800;">SEASON 2026</span>
          </div>
          <p style="font-size: 0.92rem; color: #E0E7FF; font-weight: 800; margin-bottom: 4px;">
            Giải Vô địch Những Nhà Kiến tạo Tương lai
          </p>
          <p style="font-size: 0.85rem; color: #A5B4FC; font-weight: 700; margin-bottom: 14px;">
            Thi thử hằng ngày, rèn luyện 7 nhóm năng lực NVS & bứt phá phong độ!
          </p>
          <button class="ns-btn ns-btn-primary ns-squash-press" style="width: 100%; background: linear-gradient(135deg, #F59E0B, #D97706);" onclick="window.app.navigateTo('championship_home')">
