    ...
    return `
      <div class="ns-view" data-view="student_welcome" style="flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: space-between; width: 100%; box-sizing: border-box; background: linear-gradient(180deg, #0F172A 0%, #1E1B4B 100%); color: #FFF; padding: max(24px, env(safe-area-inset-top)) 20px max(24px, env(safe-area-inset-bottom)) 20px; text-align: center;">
        ...
        <div style="width: 100%; display: flex; flex-direction: column; align-items: center; margin-top: 10px;">
          <div style="font-size: 3.5rem; margin-bottom: 8px;" class="ns-pulse-glow animate-bounce">🏆</div>
          <h1 style="font-family: var(--font-display); font-size: 1.55rem; color: #FDE047; font-weight: 900; margin: 0 0 8px 0; text-shadow: 0 3px 10px rgba(0,0,0,0.6); letter-spacing: 0.5px;">
            ĐẤU TRƯỜNG NVS 2026
          </h1>
  ...
  renderHome(studentState) {
    ...
    return `
      <div class="ns-view" data-view="student_home" style="flex: 1; display: flex; flex-direction: column; width: 100%; box-sizing: border-box; background: #F8FAFC;">
        ...
        <!-- Mobile Top HUD Bar -->
        <header style="background: #0F172A; color: #FFF; padding: max(10px, env(safe-area-inset-top)) 14px 10px 14px; display: flex; justify-content: space-between; align-items: center; border-bottom: 3px solid #334155;">
          ...
          <div class="ns-card" style="border: 2.5px solid #3B82F6; padding: 16px; box-shadow: var(--shadow-sm);">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px; width: 100%;">
              ${opts.map((opt, oIdx) => {
                ...
                return `
                  <button class="ns-option-card" onclick="window.studentController.answerExamQuestion('${qId}', '${optId}')">
  ...
  renderThankYou() {
    return `
      <div class="ns-view" data-view="student_thank_you" style="flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; width: 100%; box-sizing: border-box; background: linear-gradient(180deg, #0F172A 0%, #1E1B4B 100%); color: #FFF; padding: 24px; text-align: center;">
        <div style="font-size: 4.5rem; margin-bottom: 12px;" class="ns-pulse-glow animate-bounce">⭐</div>
        
        <h2 style="font-family: var(--font-display); font-size: 1.7rem; color: #FDE047; font-weight: 900; margin: 0 0 8px 0; text-shadow: 0 3px 10px rgba(0,0,0,0.5);">
          CẢM ƠN EM! ⭐
        </h2>
